#Solution of TDSE for a free gaussian wavepacket using FTCS Crank Nicolson Method
...
while t<tf:
    ...
    plt.title('Time Evolution of Gaussian wavepacket for free particle\n'+r'Time =%10.6f,norm =%10.6f'%(t,simpson(np.abs(us)**2,x=xs)))
    plt.pause(0.000001)

plt.savefig('/home/tux_blue/Documents/GitHub/Computational-Physics-UG/Application to some physics problems/Scrodinger Equation/TDSE/Free_Gaussian_CN-Method.png')    
plt.show()
